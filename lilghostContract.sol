...
contract LilGhost is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "LILGHOST";
    string private _symbol = "LILGHOST";
    ...
    // Innovation for protocol by LilGhost Team
